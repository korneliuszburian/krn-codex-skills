...
test/                 suites for architecture, audit, bootstrap-fixture, brief, catalog, cli, conformance, contract, frontend, install, lane, lessons, opencode, repro, rules, state, support, and ticket, plus top-level ci-workflow, hooks-guard, setup-workflow, and skill-scripts

...
| Local monolith decomposition | catalog-config at 1352 lines was split into catalog-errors (28), catalog-document (580), catalog-desired (265), catalog-plan (264), and a 238-line adapter; catalog-usage was split at 190dd42 into catalog-usage-json (264), at f76277d into catalog-usage-shell (131), at 83101ae into catalog-usage-normalize (201), at f73fdb8 into catalog-usage-paths (80), and at ecee034 into catalog-usage-lines (92), leaving a 218-line scanner; catalog-inventory at 4d11601 was split into catalog-profiles (237), at 72e26b2 into catalog-inventory-roots (79), at b03b46f into catalog-inventory-frontmatter (23), and at a05ce29 into catalog-inventory-quarantine (67), leaving a 536-line adapter now covered by a plugin-cache integration test at 15b2473; validate was split at a67debb into content-rules (235), at 9384742 into upstream-sources (71) plus path-rules (10), at 06ef341 into manifest-rules (94), at c74d767 into delivery-loop-rules (42), and at b0164be adding hook and retirement rules to manifest-rules (169), leaving a 424-line remainder; catalog-document was split at 72c3d7a into catalog-toml (309) and document operations (276) with direct tests for both; overall direct tests cover planning, TOML parsing, document operations, JSON extraction, shell reads, normalization, path rules, the rollout line reader, profile validation, root resolution, frontmatter, quarantine, content rules, upstream rules, manifest rules, hook and retirement rules, delivery-loop artifact rules, plus end-to-end scan and plugin-cache integration, with mutation falsifiers shown red then green; a read-only review missed an undefined identifier introduced by one extraction, so an end-to-end scan test now guards runtime reachability | continue with scan branch coverage | catalog-usage remains a partly-untested scanner, catalog-inventory has untested quarantine and error branches, and luna sandboxes report false test:skills and test/composition failures that pass locally |

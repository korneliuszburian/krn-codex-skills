...
| Prose and narrative construction | [StoryScope, 2604.03136v6](https://arxiv.org/abs/2604.03136) | discourse-level narrative features separate human from AI fiction better than surface style and retain most stylistic-cue performance, so a prose audit's surface tell-list is the lower-transfer layer; the paper does not test non-fiction, Polish, or detector evasion | 2026-09-11 |

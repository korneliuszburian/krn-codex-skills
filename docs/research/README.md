...
| Matt workflow evolution | [v1.1 changelog](https://www.aihero.dev/skills/skills-changelog-v1-1-wayfinder-to-spec-to-tickets-grilling-improvements), [Wayfinder](https://www.youtube.com/watch?v=F3lL98Pj90o) | decision tickets clear fog; spec names destination; implementation tickets carry slices | 2026-07-30 |

...
| Reusable frontend delivery pipeline | [frontend-delivery-pipeline.md](frontend-delivery-pipeline.md) | adopt generic core + explicit repository adapters; `engineering-full` waits for pristine fixture parity | seam inventory, fixture gate, distribution contract, or credential-boundary finding changes |

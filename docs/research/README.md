...
| Current Matt Pocock skills delta | [mattpocock-skills-current.md](mattpocock-skills-current.md) | the 2026-09-10 upstream delta contains no applicable skill, routing, or frontend mechanism | a later upstream diff changes a skill, routing/invocation contract, or KRN gains a concrete consumer for the upstream link helper |

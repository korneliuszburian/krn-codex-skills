// One owner for JavaScript lexical analysis: literal masking and comment stripping
// (the masker), and the export-symbol spans and diff line ranges the change
// contract delivers lessons through. Lexical approximation, not a full parser.

#!/usr/bin/env bash
# Publication gate. Refuses to publish without explicit authority; dry by
# default. Activation is a user decision, never automatic.
set -euo pipefail
...
gh pr create --base main --head "$BRANCH" \
  ...
  --body "Integrated through the AFK lane; worker and integrator gates exit 0 at the merged fixed point."

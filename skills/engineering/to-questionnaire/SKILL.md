...
description: Turn a decision the user cannot answer into a questionnaire document for a third party to fill in. Use when the settling knowledge lives outside the repo and outside the user. Compose with domain-modeling; skip user-answerable questions and pure synthesis (to-spec).
---

...
# Frontend library — the canonical CUBE CSS component set

`library/` contains the complete, up-to-date component library from the rekurencja
boilerplate (https://github.com/rekurencja/boilerplate-rekurencja), copied verbatim.
This library IS the project standard.
...
- `library/` — the verbatim component library (source: github.com/rekurencja/boilerplate-rekurencja, theme `src/css/` + `src/design-tokens/`).
